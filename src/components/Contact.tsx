  ...
  return (
    <section id="contact" ref={sectionRef} className="relative py-24 lg:py-32 bg-gradient-to-b from-[#121212] to-[#0B0B0B]">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <span className="text-[#C9A24D] text-xl tracking-[0.3em] uppercase mb-4 block">Get In Touch</span>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#C9A24D] text-[#0B0B0B] py-4 uppercase tracking-wider hover:bg-[#D4AD5A] transition-colors duration-300 relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
              >
