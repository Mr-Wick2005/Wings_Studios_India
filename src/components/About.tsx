          ...
          >
            ...
            >
              <p className="text-[#CCCCCC] text-lg leading-relaxed">
                Wings Studios India is a fully integrated film and digital
                production company delivering end-to-end solutions—from concept
                development to final delivery.
              </p>
              <p className="text-[#999999] leading-relaxed">
                Based in Mumbai, we combine cinematic excellence with
                cutting-edge technology to create compelling narratives for
                brands, agencies, and content platforms. Our approach blends
                traditional storytelling mastery with AI-assisted workflows,
                enabling us to visualize faster and produce smarter.
              </p>
            </motion.div>
            ...
            >
              <div className="border-l-2 border-[#C9A24D] pl-4">
                ...
                <div className="text-sm text-[#999999] uppercase tracking-wide">
                  Projects
                </div>
              </div>
              <div className="border-l-2 border-[#C9A24D] pl-4">
